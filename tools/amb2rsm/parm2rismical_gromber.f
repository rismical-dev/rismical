...
c     NOTE: For the parm7 file generated by gromber
c
c     Usage: parm2rismcal_gromber [parm7] [pdb|crd] ([format])
c
...
c     read atom_name
 ...
 210     continue
         read(3,'(A256)') char256
         if (char256(1:8).eq."%COMMENT") goto 210
         do i=1,numatoms,20
...
c     read charge
 ...
 310     continue
         read(3,'(A256)') char256
         if (char256(1:8).eq."%COMMENT") goto 310
         nr=3
         do i=1,numatoms,nr
            jmax=min(numatoms,i+nr-1)
            read(3,*) (charge(j),j=i,jmax)
         enddo
      else
         goto 300
      endif
...
c     read ATOM_TYPE_INDEX
 ...
 410     continue
         read(3,'(A256)') char256
         if (char256(1:8).eq."%COMMENT") goto 410
         do i=1,numatoms,10
...
c     read NONBONDED_PARM_INDEX
 ...
 510     continue
         read(3,'(A256)') char256
         if (char256(1:8).eq."%COMMENT") goto 510
...
c     read FLAG LENNARD_JONES_ACOEF                                                       
 ...
 610     continue
         read(3,'(A256)') char256
         if (char256(1:8).eq."%COMMENT") goto 610
         nr=3
         do i=1,numnonbondedparamtype,nr
            jmax=min(numnonbondedparamtype,i+nr-1)
            read(3,*) (lja(j),j=i,jmax)
         enddo
      else
         goto 600
      endif
...
c     read FLAG LENNARD_JONES_BCOEF                       
 ...
 710     continue
         read(3,'(A256)') char256
         if (char256(1:8).eq."%COMMENT") goto 710
         nr=3
         do i=1,numnonbondedparamtype,nr
            jmax=min(numnonbondedparamtype,i+nr-1)
            read(3,*) (ljb(j),j=i,jmax)
         enddo
      else
         goto 700
      endif
